...
type
  ...
  public
    ...
    constructor Create(AUserId, AUserName: string; const ADeviceId, ADeviceToken, ADeviceModel, AOSName, AOSVer, AAppVer,
...
{ TPushDevice }
constructor TPushDevice.Create(AUserId, AUserName: string; const ADeviceId, ADeviceToken, ADeviceModel, AOSName, AOSVer, AAppVer,
      AReceivePush: string);
begin
  inherited Create;
  FUserId:= AUserId;
