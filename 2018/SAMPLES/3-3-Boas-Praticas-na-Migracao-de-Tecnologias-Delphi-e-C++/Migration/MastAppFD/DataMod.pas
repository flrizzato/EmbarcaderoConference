...
uses
  ...
  System.UITypes, FireDAC.Phys.Intf, FireDAC.Stan.Intf, FireDAC.Stan.Option, 
  ...
  FireDAC.VCLUI.Wait, FireDAC.Phys.IB, FireDAC.Phys.IBDef;
...
//      FDManager.AddConnectionDef('MASTSQL', 'INTRBASE', Params);
//    finally
//       Params.Free;
//    end;
//  end;
...
begin
  ...
  if MessageDlg(Format(UpdErrMsg, [E.Message, DataSet.Fields[0].DisplayLabel, Key]),
    ...
    UpdateAction := eaSkip else
    UpdateAction := eaExitFailure;
end;
