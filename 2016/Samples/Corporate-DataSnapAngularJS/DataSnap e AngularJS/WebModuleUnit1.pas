...
begin
  if SameText(TagString, 'urlpath') then
    ...
    if AllowServerFunctionInvoker then
      ReplaceText := '<div>' +
        '<a href="' + string(Request.InternalScriptName) + '/ServerFunctionInvoker" target="_blank">Server Functions</a><br/>' +
        '<a href="' + string(Request.InternalScriptName) + '/getimage">Imagens</a><br/>' +
        '<a href="' + string(Request.InternalScriptName) + '/dados">Dados</a><br/>' +
      '</div>'
    else
      ReplaceText := '';
end;
