...
function TServerMethods1(connectionInfo)
{
  ...
  this.GetImage = function() {
    var returnObject = this.executor.executeMethod('GetImage', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetImage_URL = function() {
    return this.executor.getMethodURL("GetImage", "GET", [], arguments[0])[0];
  };

  /*
   * @param Img2 [out] - Type on server: TStream
   * @return result - Type on server: TStream
   */
  this.GetImages = function() {
    var returnObject = this.executor.executeMethod('GetImages', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.Img2 = resultArray[0];
        resultObject.result = resultArray[1];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.GetImages_URL = function() {
    return this.executor.getMethodURL("GetImages", "GET", [], arguments[0])[0];
  };
}

function TsmCachedData(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TsmCachedData",connectionInfo);

  /*
   * @return result - Type on server: TDataSet
   */
  this.Countries = function() {
    var returnObject = this.executor.executeMethod('Countries', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.Countries_URL = function() {
    return this.executor.getMethodURL("Countries", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["EchoString","ReverseString","GetImage","GetImages"],
  "TsmCachedData": ["Countries"]
};
