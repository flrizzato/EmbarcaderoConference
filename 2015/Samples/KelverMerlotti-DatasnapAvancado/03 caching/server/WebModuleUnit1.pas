...
type
  TWebModule1 = class(TWebModule)
    ...
    DsServerClassCachedData: TDSServerClass;
    ...
    procedure DsServerClassCachedDataGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
  private
...
uses ServerMethodsUnit1, Web.WebReq, uServerMethodsCachedData;
...
procedure TWebModule1.DsServerClassCachedDataGetClass(DSServerClass: TDSServerClass;
  var PersistentClass: TPersistentClass);
begin
  PersistentClass := uServerMethodsCachedData.TsmCachedData;
end;
