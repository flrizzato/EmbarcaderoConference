  ...
  try
    ...
    try
      ...
      try
        ...
        //Result := amazonService.UploadObject(bucketName, AFileName, Content, false, nil, nil, amzbaNotSpecified, RespInfo);
        //Content := ByteContent(bstr);
        Result := amazonService.UploadObject(bucketName, AFileName, bstr.Bytes);
        //Result := amazonService.UploadObject(bucketName, AFileName, bstr.Bytes, false, nil, nil, amzbaNotSpecified, RespInfo);
      finally
        RespInfo.Free;
      end;
    finally
