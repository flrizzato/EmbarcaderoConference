...
type
  TWebModule1 = class(TWebModule)
    ...
    DSServerClassDSMPalestra: TDSServerClass;
    ...
    procedure DSServerClassDSMPalestraGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
  private
...
uses ServerMethodsUnit1, Web.WebReq, U_DSMPalestra;
...
procedure TWebModule1.DSServerClassDSMPalestraGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
   PersistentClass := U_DSMPalestra.TDSMPalestra;
end;
