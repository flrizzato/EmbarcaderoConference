...
type
  TFrmFormFiremonkeyHD = class(TForm3D)
    Light1: TLight;
    Light2: TLight;
    Layer3D1: TLayer3D;
    LeftPlane: TPlane;
...
procedure TFrmFormFiremonkeyHD.Form3DCreate(Sender: TObject);
begin
  Application.OnIdle := AppIdle;
end;

procedure TFrmFormFiremonkeyHD.Timer1Timer(Sender: TObject);
var
  Done : Boolean;
begin
...
procedure TFrmFormFiremonkeyHD.BackPlaneMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single; RayPos, RayDir: TVector3D);
begin
  Down := PointF(X, Y);
end;

procedure TFrmFormFiremonkeyHD.BackPlaneMouseMove(Sender: TObject; Shift: TShiftState; X,
...
procedure TFrmFormFiremonkeyHD.AppIdle(Sender: TObject; var Done: Boolean);
var
  V : Single;
begin
