...
var
  ...
  LBytes: TArray<Byte>;
  LDstStream: TMemoryStream; // Added
  Zipper: TZCompressionStream; // Added
begin
  LMemTable := nil;
  LAdapter := nil;
  try
    ...
    try
      ...
      SetLength(LBytes, LDstStream.Size);
      LDstStream.Read(LBytes[0], Length(LBytes));
    finally
      LDstStream.Free;
      LMemoryStream.Free;
    end;
...
var
  ...
  LBytes: TArray<Byte>;
  LMemoryStream: TMemoryStream;
  LOrgStream: TMemoryStream; // Added
  Unzipper: TZDecompressionStream; // Added
begin
  LMemTable := TFDMemTable.Create(nil);
  ...
  try
    ...
    begin
      ...
      try
        LOrgStream.Write(LBytes[0], Length(LBytes));
