...
uses
  ...
  Forms, Dialogs, DB, StdCtrls, ExtCtrls, Grids, DBGrids, Buttons, UITypes;
...
begin
  Result := MastData.cdsCustCustNo.Value;
end;
...
begin
  Result := MastData.cdsPartsPartNo.Value;
end;
...
begin
  ...
  Datasource.Dataset := MastData.cdsCust;
...
begin
  ...
  OrderCombo.ItemIndex := 0;
  Datasource.Dataset := MastData.cdsParts;
  OrderComboChange(nil);
