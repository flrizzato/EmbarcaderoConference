...
procedure TWebModule1.DSAuthenticationManager1UserAuthorize(Sender: TObject;
  AuthorizeEventObject: TDSAuthorizeEventObject; var valid: Boolean);
var
  resultado: TDSRoleComparison;
begin
  resultado := DSAuthenticationManager1.CompareRoles(AuthorizeEventObject.UserRoles, AuthorizeEventObject.AuthorizedRoles, AuthorizeEventObject.DeniedRoles);
  case resultado of
    rcNoUserRoles: valid := False;
    rcNoMethodRoles: valid := False;
    rcUserRoleAllowed: valid := True;
    rcUserRoleDenied: valid := False;
    rcNoMatch: valid := False;
  end;
end;
