...
uses
  ...
  FireDAC.Comp.Client, Vcl.StdCtrls, FireDAC.VCLUI.Error;
...
type
  ...
  private
    ...
    procedure SetDatdos(Banco: TBanco);
  public
    { Public declarations }
  end;
...
begin
  SetDatdos(TBanco.Interbase);
end;

procedure TForm8.Button2Click(Sender: TObject);
begin
  SetDatdos(TBanco.SqlServer);
end;
...
procedure TForm8.SetDatdos(Banco: TBanco);
begin
  FDConnection1.Close();
  case Banco of
    Interbase:
